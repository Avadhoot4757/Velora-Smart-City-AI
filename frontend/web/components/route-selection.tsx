  ...
  const [routes, setRoutes] = useState([
    {
      ...
      navigationSteps: [
        "Head towards Outer Ring Road",
        "Take the eco-friendly route via tree-lined streets",
        "Continue on the green corridor",
        "Follow the low-pollution path",
    ...
    },
    {
      ...
      navigationSteps: [
        "Start on the heart-friendly route",
        "Take Hosur Road for better air quality",
        "Follow the low-noise path",
        "Continue on peaceful streets",
    ...
    },
    {
      ...
      navigationSteps: [
        "Take the fastest route via Intermediate Ring Road",
        "Follow the optimized path",
        "Continue on the express route",
        "Take the shortest path to destination",
        "Arrive at your destination quickly",
      ],
    },
    {
      id: 4,
      ...
      navigationSteps: [
        "Take the safe route via 100 Feet Road",
        "Follow well-lit streets",
        "Continue on high-visibility roads",
